...
function OpenDesktopApp(props: OpenDesktopAppProps) {
    ...
    return (
        <div>
            <div className="desktop-app_behind" onClick={closeAppCallback}></div>
                    ...
                    <div className="app-description_wrapper">
                        { app && app.description && app.description.length > 0 &&
                            app.description.map((paragraph, key) => {
                                return (
                                    <p key={key}>
                                        <img className="app-description--icon" src={iconImagePath} alt="bullet points for description"></img>
                                        {paragraph}
                                    </p>
                                );
                            })
